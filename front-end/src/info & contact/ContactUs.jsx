...
//                 {/* Contact Items - This section will grow to fill available space */}
...
//                   <button
//                     type="submit"
//                     className="w-full group relative overflow-hidden bg-gradient-to-r from-[#22258a] to-[#0e0f38] text-white py-4 px-6 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] transform"
//                   >
