      ...
      <div className="otherRooms">
        ...
        <div className="restaurant" ref={ref}>
          <motion.div style={{ x: scrollX, opacity: scrollOpacity }}>
            ...
            <p>
              Perched on the edge of culinary delight, the restaurant's veranda
              is a charming retreat that invites guests to dine amidst nature's
              ...
              experience. Here, under the open sky and gentle breeze, patrons
              can indulge in the art of gastronomy while basking in the warm
              glow of ambient lighting. The veranda seamlessly blends the rustic
              charm of outdoor dining with the sophistication of an upscale
              establishment, offering a perfect balance for those seeking an al
              fresco escape. It is a haven where the clinking of glasses mingles
              with the melodies of nature, creating an ambiance that elevates
              every bite to a symphony of sensory pleasure.
            </p>
        ...
        <div className="restaurant" ref={ref2}>
          <motion.div style={{ x: scrollX2, opacity: scrollOpacity2 }}>
            ...
            <p>
              ...
              atmosphere. Meanwhile, the well-curated beverage selection offers
              an exploration of local flavors and international classics,
              providing the perfect accompaniment to the gastronomic journey. In
              this culinary sanctuary, every bite and sip become a passage
              through time, inviting guests to savor the essence of tradition in
              each mouthful.
            </p>
            <div className="restaurantIcons">
              <div className="restaurantIcon">
        ...
        <div className="restaurant" ref={ref3}>
          <motion.div style={{ x: scrollX3, opacity: scrollOpacity3 }}>
            ...
            <p>
              ...
              ambiance that seamlessly blends modern luxury with timeless charm.
              Tables adorned with crisp linens await, offering a setting that
              beckons both intimate dinners and celebratory gatherings. The soft
              glow of ambient lighting enhances the dining room's allure,
              casting a warm glow on the faces of patrons engaged in the joyous
              act of shared meals. Impeccable service ensures that every moment
              within this gastronomic haven is a celebration, where each dish is
              presented with precision, and every sip of wine is a toast to
              culinary craftsmanship. The dining room becomes a theater of
              taste, a space where conversations flow as effortlessly as the
              courses, and where the art of dining unfolds in an atmosphere of
              refined indulgence.
            </p>
            <div className="restaurantIcon">
              <button>
