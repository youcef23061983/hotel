    ...
    <div>
      ...
      <div className="otherRooms">
        ...
        <div className="restaurant">
          ...
          <p>
            Perched on the edge of culinary delight, the restaurant's veranda is
            a charming retreat that invites guests to dine amidst nature's
            embrace. Overlooking the scenic landscapes of Batu Ferringhi, the
            veranda provides an enchanting setting for a memorable dining
            experience. Here, under the open sky and gentle breeze, patrons can
            indulge in the art of gastronomy while basking in the warm glow of
            ambient lighting. The veranda seamlessly blends the rustic charm of
            outdoor dining with the sophistication of an upscale establishment,
            offering a perfect balance for those seeking an al fresco escape. It
            is a haven where the clinking of glasses mingles with the melodies
            of nature, creating an ambiance that elevates every bite to a
        ...
        <div className="restaurant">
          ...
          <p>
            ...
            traditional food and drink restaurant exudes an air of nostalgia and
            authenticity. The menu is a treasure trove of time-honored recipes,
            each dish a testament to the rich tapestry of culinary heritage.
            From aromatic curries that tell tales of spice-laden marketplaces to
            savory kebabs reminiscent of ancient feasts, the restaurant
            celebrates the artistry of traditional cooking. The ambiance
            resonates with the comforting warmth of familiarity, where wooden
            accents and earthy tones create an inviting atmosphere. Meanwhile,
            the well-curated beverage selection offers an exploration of local
            flavors and international classics, providing the perfect
            accompaniment to the gastronomic journey. In this culinary
            sanctuary, every bite and sip become a passage through time,
            inviting guests to savor the essence of tradition in each mouthful.
          </p>
          <div className="restaurantIcons">
            <div className="restaurantIcon">
              <button>
        ...
        <div className="restaurant">
          ...
          <p>
            Within the dining room's elegant confines, the atmosphere is one of
            refined sophistication, setting the stage for an unparalleled
            culinary experience. Rich hues and tasteful decor create an ambiance
            that seamlessly blends modern luxury with timeless charm. Tables
            adorned with crisp linens await, offering a setting that beckons
            both intimate dinners and celebratory gatherings. The soft glow of
            ambient lighting enhances the dining room's allure, casting a warm
            glow on the faces of patrons engaged in the joyous act of shared
            meals. Impeccable service ensures that every moment within this
            gastronomic haven is a celebration, where each dish is presented
            with precision, and every sip of wine is a toast to culinary
            craftsmanship. The dining room becomes a theater of taste, a space
            where conversations flow as effortlessly as the courses, and where
            the art of dining unfolds in an atmosphere of refined indulgence.
          </p>
          <div className="restaurantIcon">
            <button>
              <PiClockAfternoonThin />
