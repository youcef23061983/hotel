        ...
        >
          <div className="guestInfo">
            ...
            <div className="guestDiv">
              <div className="guestTitle">
                ...
                <select name="title" value={user.title} onChange={handleChange}>
            ...
            <div className="guestDiv">
              <div className="guestTitle">
                <label htmlFor="countryCode">Phone Number(country code)*</label>
                <select
                  class="form-select"
                  id="phone"
                  name="countryCode"
          ...
          <div className="policy">
            ...
            <div className="roomPolicy">
              ...
              <p>
                All reservations must be guaranteed with a credit card valid at
                the date of the start of your stay, unless otherwise specified
              </p>
            </div>
            <div className="roomPolicy">
              <h3>Cancellation Policy:</h3>
              <p>
                No cancellation charge applies prior to 15:00 (local time), up
                to 1 day prior to arrival. Beyond that time, the first night
                will be charged.
              </p>
            </div>
            <div className="roomPolicy">
              ...
              <p>
                Pets up to 10 kg are welcome in our hotel. Fee of 150 PLN per
                night per pet will be added to the bill upon check out.
              </p>
            </div>
            <div className="roomPolicy">
            ...
            <div className="roomPolicy">
              ...
              <p>
                Depending on the hotel's policy regarding children, supplements
                for children apply and are included in the total amount of the
                reservation. See the tariff terms and conditions when booking.
              </p>
            </div>{" "}
            <div className="roomPolicy">
              ...
              <p>
                ...
                member number if they have not yet received their card. Maximum
                2 rooms at the Members Rate can be booked per member per stay.
              </p>
            </div>{" "}
            <div className="roomPolicy">
              <p>
                * I have read and agree to the reservation terms and conditions
                stated above.
              </p>
              <p>
                * I understand that by selecting the Submit Details button, I am
                authorizing a charge on the credit card number provided to
                purchase the room and tax as specified in the reservation
                details. I understand that the cancellation policy stated in the
                Full Room Rate Summary is in effect.
              </p>
