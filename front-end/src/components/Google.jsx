        ...
        <div className="section" ref={ref}>
          ...
          <div className="p">
            ...
            >
              ...
              this coastal haven is a melting pot of cultural vibrancy and
              natural beauty. The name "Batu Ferringhi" translates to
              "Foreigner's Rock," echoing its history as a favored retreat for
              international travelers. Visitors are greeted with a tapestry of
              experiences, from the bustling night markets offering local crafts
              and delectable street food to the serene beachfront, where the
              sunsets paint the sky in hues of orange and pink. Adventure
              enthusiasts can indulge in water sports, while cultural explorers
              can immerse themselves in the vibrant arts scene. Batu Ferringhi
              seamlessly combines relaxation and excitement, making it a
              sought-after destination where every corner reveals a new facet of
              its seaside splendor.
            </motion.p>
          </div>
        </div>
      </ReactLenis>
