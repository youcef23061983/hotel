                ...
                <div className="policy">
                  ...
                  <div className="roomPolicy">
                    ...
                    <p>
                      ...
                      valid at the date of the start of your stay, unless
                      otherwise specified
                    </p>
                  </div>
                  <div className="roomPolicy">
                    ...
                    <p>
                      No cancellation charge applies prior to 15:00 (local
                      time), up to 1 day prior to arrival. Beyond that time, the
                  ...
                  <div className="roomPolicy">
                    ...
                    <p>
                      ...
                      per night per pet will be added to the bill upon check
                      out.
                    </p>
                  </div>
                  <div className="roomPolicy">
                  ...
                  <div className="roomPolicy">
                    ...
                    <p>
                      ...
                      supplements for children apply and are included in the
                      total amount of the reservation. See the tariff terms and
                  ...
                  <div className="roomPolicy">
                    ...
                    <p>
                      Be or become a member of ALL - Accor Live Limitless.
                      Members must present their card upon check in at the hotel
                      or their member number if they have not yet received their
                      card. Maximum 2 rooms at the Members Rate can be booked
                      per member per stay.
                    </p>
                  </div>{" "}
                  <div className="roomPolicy">
                    ...
                    <p>
                      * I understand that by selecting the Submit Details
                      button, I am authorizing a charge on the credit card
                      number provided to purchase the room and tax as specified
                      in the reservation details. I understand that the
                      cancellation policy stated in the Full Room Rate Summary
                      is in effect.
                    </p>
